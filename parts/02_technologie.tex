...
\lstinputlisting[style=htmlcssjs,captionpos=b,caption=HTML]{ukazky/html.html}
...
\lstinputlisting[style=css,captionpos=b,caption=CSS]{ukazky/css.css}
...
\lstinputlisting[style=js,captionpos=b,caption=Javascript]{ukazky/js.js}
...
\lstinputlisting[style=js,captionpos=b,caption=JSON]{ukazky/json.json}
...
\lstinputlisting[style=php,captionpos=b,caption=PHP]{ukazky/php.php}
...
\lstinputlisting[style=sql,captionpos=b,caption=SQL]{ukazky/mysql.sql}
